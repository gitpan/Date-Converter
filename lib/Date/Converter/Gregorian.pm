package Date::Converter::Gregorian;
...
sub ymdf_to_jed {
    ...
    my $jed = $j1 + $j2 + $d_prime - 1401 - $g - 0.5;
    $jed += $f;
...
sub jed_to_ymdf {
    ...
    my ($g, $j_prime, $y_prime, $t_prime, $m_prime, $d_prime, $d, $m, $y);
    {
        use integer;
